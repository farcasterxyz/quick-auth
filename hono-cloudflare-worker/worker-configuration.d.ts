/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: a14e2b0e537ba781771da0e35e0426a5)
// Runtime types generated with workerd@1.20250508.0 2025-05-06 
declare namespace Cloudflare {
	interface Env {
		...
		ETH_RPC_URLS: string;
		HOST: string;
		NONCE: DurableObjectNamespace<import("./src/index").Nonce>;
		NONCE_POOL: DurableObjectNamespace<import("./src/index").NoncePool>;
		VERIFY_SIWF_REQS: AnalyticsEngineDataset;
	}
}
